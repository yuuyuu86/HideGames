...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main className={page === 'play' ? 'play-main' : 'main'}>
      ...
      {page === 'home' && <HomeScreen setPage={setPage} start={start} favourites={player.data.favourites} matches={player.data.matches} />}
