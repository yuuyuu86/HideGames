...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main className={page === 'play' ? 'play-main' : 'main'}>
      ...
      {page === 'home' && <HomeScreen setPage={setPage} start={openLobby} createRoom={room.createRoom} favourites={player.data.favourites} matches={player.data.matches} />}
