...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main className={page === 'play' ? 'play-main' : 'main'}>
      ...
      {page === 'home' && <HomeScreen setPage={setPage} start={openLobby} createRoom={room.createRoom} invitations={room.invitations} onAcceptInvitation={invitation=>{if(room.joinRoom(invitation.code)){room.dismissInvitation(invitation.id);setPage('room')}}} onDismissInvitation={room.dismissInvitation} favourites={player.data.favourites} matches={player.data.matches} />}
