...
function SettingsScreenV2({brightness,setBrightness,shortcut,setShortcut}:{brightness:number;setBrightness:(v:number)=>void;shortcut:string;setShortcut:(value:string)=>void}){
  type Preferences={bright:boolean;chat:boolean;notifications:boolean;chatNotifications:boolean;roomNotifications:boolean;gameNotifications:boolean;fontScale:number;colorSafe:boolean;reducedMotion:boolean;captions:boolean;bgm:number;sfx:number;voice:number;youtube:number}
  const defaults:Preferences={bright:true,chat:true,notifications:true,chatNotifications:true,roomNotifications:true,gameNotifications:true,fontScale:100,colorSafe:false,reducedMotion:false,captions:false,bgm:70,sfx:70,voice:80,youtube:80}
